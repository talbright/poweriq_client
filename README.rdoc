...
==== Console Options
 ...
 Usage: poweriq_client [options]
    -l, --less-typing                Put resource objects in global namespace (ie PowerIQ::Resource::Outlet becomes Outlet)
    -c, --check-compatability        Check client compatibility with server
...
If you do not use a configuration file you'll need to provide the configuration manually:
